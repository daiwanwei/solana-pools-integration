...
export function getTickArrayStateEncoder(): Encoder<TickArrayStateArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['padding', getArrayEncoder(getU8Encoder(), { size: 107 })],
    ]),
    (value) => ({ ...value, discriminator: TICK_ARRAY_STATE_DISCRIMINATOR })
  );
}

export function getTickArrayStateDecoder(): Decoder<TickArrayState> {
  return getStructDecoder([
    ...
    ['padding', getArrayDecoder(getU8Decoder(), { size: 107 })],
  ]);
}

export function getTickArrayStateCodec(): Codec<
  TickArrayStateArgs,
  TickArrayState
> {
