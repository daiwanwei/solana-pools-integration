...
export const DECREASE_RAYDIUM_LIQUIDITY_DISCRIMINATOR = new Uint8Array([
  71, 255, 20, 254, 238, 56, 115, 33,
]);

export function getDecreaseRaydiumLiquidityDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    DECREASE_RAYDIUM_LIQUIDITY_DISCRIMINATOR
  );
}

export type DecreaseRaydiumLiquidityInstruction<
...
export type DecreaseRaydiumLiquidityInstructionData = {
...
export type DecreaseRaydiumLiquidityInstructionDataArgs = {
  liquidity: number | bigint;
  amount0Min: number | bigint;
  amount1Min: number | bigint;
};

export function getDecreaseRaydiumLiquidityInstructionDataEncoder(): Encoder<DecreaseRaydiumLiquidityInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
      ['liquidity', getU128Encoder()],
      ['amount0Min', getU64Encoder()],
      ['amount1Min', getU64Encoder()],
    ]),
    (value) => ({
      ...value,
      discriminator: DECREASE_RAYDIUM_LIQUIDITY_DISCRIMINATOR,
    })
  );
}

export function getDecreaseRaydiumLiquidityInstructionDataDecoder(): Decoder<DecreaseRaydiumLiquidityInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
    ['liquidity', getU128Decoder()],
    ['amount0Min', getU64Decoder()],
    ['amount1Min', getU64Decoder()],
  ]);
}

export function getDecreaseRaydiumLiquidityInstructionDataCodec(): Codec<
  DecreaseRaydiumLiquidityInstructionDataArgs,
  DecreaseRaydiumLiquidityInstructionData
> {
  return combineCodec(
    getDecreaseRaydiumLiquidityInstructionDataEncoder(),
    getDecreaseRaydiumLiquidityInstructionDataDecoder()
  );
}

export type DecreaseRaydiumLiquidityInput<
...
> = {
  ...
  liquidity: DecreaseRaydiumLiquidityInstructionDataArgs['liquidity'];
  amount0Min: DecreaseRaydiumLiquidityInstructionDataArgs['amount0Min'];
  amount1Min: DecreaseRaydiumLiquidityInstructionDataArgs['amount1Min'];
};

export function getDecreaseRaydiumLiquidityInstruction<
  TAccountSigner extends string,
  TAccountConfig extends string,
  TAccountRaydiumProtocolPosition extends string,
  TAccountRaydiumUserPosition extends string,
...
>(
  input: DecreaseRaydiumLiquidityInput<
    TAccountSigner,
    TAccountConfig,
    TAccountRaydiumProtocolPosition,
    TAccountRaydiumUserPosition,
...
): DecreaseRaydiumLiquidityInstruction<
  TProgramAddress,
  TAccountSigner,
  TAccountConfig,
  TAccountRaydiumProtocolPosition,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDecreaseRaydiumLiquidityInstructionDataEncoder().encode(
      args as DecreaseRaydiumLiquidityInstructionDataArgs
    ),
  } as DecreaseRaydiumLiquidityInstruction<
    TProgramAddress,
    TAccountSigner,
    TAccountConfig,
    TAccountRaydiumProtocolPosition,
...
export type ParsedDecreaseRaydiumLiquidityInstruction<
  TProgram extends string = typeof LIQUIDITY_PROXY_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DecreaseRaydiumLiquidityInstructionData;
};

export function parseDecreaseRaydiumLiquidityInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedDecreaseRaydiumLiquidityInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDecreaseRaydiumLiquidityInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
