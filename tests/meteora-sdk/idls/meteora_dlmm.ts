...
export type MeteoraDlmm = {
  ...
  instructions: [
    ...
    },
    {
      ...
      discriminator: [4, 105, 92, 167, 132, 28, 9, 90];
      accounts: [
        {
          name: "lbPair";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [148, 71, 56, 20, 55, 218, 152, 133];
      accounts: [
        {
          name: "position";
          writable: true;
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "baseFactor";
            docs: ["Used for base fee calculation. base_fee_rate = base_factor * bin_step"];
            type: "u16";
          },
          {
            name: "filterPeriod";
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ["Is the position subjected to liquidity locking for the launch pool."];
            type: "u8";
          },
          {
            name: "feeOwner";
